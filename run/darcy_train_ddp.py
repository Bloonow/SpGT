...
def darcy_train_ddp(cfg):
    ...
    train_sampler = DistributedSampler(train_ds, seed=cfg['seed'], shuffle=True)
    valid_sampler = DistributedSampler(valid_ds, seed=cfg['seed'], shuffle=False)
    train_loader = DataLoader(train_ds, cfg['batch_size'], sampler=train_sampler, num_workers=cfg['num_worker'], pin_memory=True)
    valid_loader = DataLoader(valid_ds, cfg['batch_size'], sampler=valid_sampler, num_workers=cfg['num_worker'], pin_memory=True)
