...
std::tuple<Tensor,Tensor> gather_transpose_dual(
    ...
    datamove::gather_transpose_2D_cuda(src_ptr + N1_offset1 * N0, out1_ptr, M, N0, N1, n0, n1);
    datamove::gather_transpose_2D_cuda(src_ptr + N1_offset2 * N0, out2_ptr, M, N0, N1, n0, n1);
...
Tensor scatter_transpose_dual(
    ...
    datamove::scatter_transpose_2D_cuda(src1_ptr, out_ptr + N1_offset1 * N0, M, N0, N1, n0, n1);
    datamove::scatter_transpose_2D_cuda(src2_ptr, out_ptr + N1_offset2 * N0, M, N0, N1, n0, n1);
    return std::move(out);
}
