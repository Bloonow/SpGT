...
from SpGT.common.path import FIGURE_PATH
...
plt.savefig(os.path.join(FIGURE_PATH, 'projpos_lnorm_wrt_batch.png'), format='png', transparent=True, dpi=360, bbox_inches='tight')
plt.show()
